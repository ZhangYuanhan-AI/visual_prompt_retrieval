...
save_dir = "/mnt/lustre/yhzhang/data/imagenet/features_supcon_bs256_val"
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
else:
    print(f"Directory exists at {save_dir}")
...
model.load_state_dict(clean_state_dict(torch.load('/mnt/lustre/yhzhang/SupContrast/save/SupCon/path_models/SupCon_path_resnet50_seed_0_lr_0.005_decay_0.0001_cropsz_224_bsz_256_temp_0.1_trial_0_cosine_pretrain/last.pth')['model']))
model.eval()
model = model.cuda()
