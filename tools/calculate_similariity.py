...
# features_name_list = [
#     'features_rn50_val',
#     'features_vit-eva_val',
#     'features_vit-in21k-ft-in1k_val',
#     # 'features_rn18_val',
#     # 'features_vit-laion2b-ft-in12k-in1k_val',
#     # 'features_vit-dino_val'
# ]
features_name_list = sys.argv[1:]

for features_name in features_name_list:

    features_dir = os.path.join('/mnt/lustre/yhzhang/data/imagenet',features_name)
