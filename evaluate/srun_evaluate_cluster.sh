...
do
    ...
    do
        ...
        python evaluate_segmentation.py --model mae_vit_large_patch16 --base_dir ~/data/pascal-5i/ --output_dir output_images/output_cluster_eva_${folderid}_${seed} --ckpt ../weights/checkpoint-3400.pth --split ${folderid} --seed ${seed} --cluster \
