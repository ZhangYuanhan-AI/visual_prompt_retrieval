...
python evaluate_colorization.py --model mae_vit_large_patch16 --output_dir output_color_images/output_supcon_bsz64_val --ckpt ../weights/checkpoint-1000.pth --data_path /mnt/lustre/yhzhang/data/imagenet \
